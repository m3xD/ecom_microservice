...
# Payment API configs - for a real system, these would be real credentials
STRIPE_API_KEY = os.getenv('STRIPE_API_KEY', 'sk_test_example_key')
PAYPAL_CLIENT_ID = os.getenv('PAYPAL_CLIENT_ID', 'test_client_id')
